#ifndef __Qt_App_Posp_T3D_CHM_up_mt_Div_h__
#define __Qt_App_Posp_T3D_CHM_up_mt_Div_h__
...
#include "QtGLView.h"
#include "QtSceneFromHdf5_T3D_CHM_up_mt_Div.h"
#include "QtController_Posp_Static.h"
#include "QtController_Posp_Animation.h"

template <class DivisionSet>
class QtApp_Posp_T3D_CHM_up_mt_Div;

namespace QtApp_Posp_T3D_CHM_up_mt_Div_Internal
{
...
protected:
	template <class DivisionSet>
	friend class QtApp_Posp_T3D_CHM_up_mt_Div;
...
protected:
	...
	QtApp_Posp_T3D_CHM_up_mt_Div_Internal::MainWindow window;
	QtSceneFromHdf5_T3D_CHM_up_mt_Div<DivisionSet> scene;
	QtController *pcontroller;

public:
	QtApp_Posp_T3D_CHM_up_mt_Div(int &argc, char **argv, Type tp = SingleFrame);
	~QtApp_Posp_T3D_CHM_up_mt_Div();
...
template <class DivisionSet>
QtApp_Posp_T3D_CHM_up_mt_Div<DivisionSet>
	::QtApp_Posp_T3D_CHM_up_mt_Div(
...
template <class DivisionSet>
int QtApp_Posp_T3D_CHM_up_mt_Div<DivisionSet>::start()
{
	window.show();
	return app.exec();
}
