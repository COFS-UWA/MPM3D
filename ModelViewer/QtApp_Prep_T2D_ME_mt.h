#ifndef __Qt_App_Prep_T2D_ME_mt_h__
#define __Qt_App_Prep_T2D_ME_mt_h__
...
class QtApp_Prep_T2D_ME_mt;

namespace QtApp_Prep_T2D_ME_mt_Internal
{
...
protected:
	...
	QtApp_Prep_T2D_ME_mt_Internal::MainWindow window;
	QtSceneFromModel_T2D_ME_mt scene;
	QtController_Prep controller;

public:
	QtApp_Prep_T2D_ME_mt(int &argc, char **argv);
	~QtApp_Prep_T2D_ME_mt();
	...
	inline void set_model(Model_T2D_ME_mt& model) { scene.set_model(model); }
