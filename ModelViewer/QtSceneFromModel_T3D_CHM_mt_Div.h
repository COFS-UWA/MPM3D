#ifndef __Qt_Scene_From_Model_T3D_CHM_mt_Div_h__
#define __Qt_Scene_From_Model_T3D_CHM_mt_Div_h__
...
class QtSceneFromModel_T3D_CHM_mt_Div :
	public QtSceneFromModel_T3D_CHM_mt
{
protected:
	DivisionSet div_set;

public:
	QtSceneFromModel_T3D_CHM_mt_Div(QOpenGLFunctions_3_3_Core& _gl) :
		QtSceneFromModel_T3D_CHM_mt(_gl) {}
	~QtSceneFromModel_T3D_CHM_mt_Div() {}
