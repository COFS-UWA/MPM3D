#ifndef __Qt_App_Posp_T3D_ME_s_h__
#define __Qt_App_Posp_T3D_ME_s_h__
...
class QtApp_Posp_T3D_ME_s;

namespace QtApp_Posp_T3D_ME_s_Internal
{
...
protected:
	...
	QtApp_Posp_T3D_ME_s_Internal::MainWindow window;
	QtSceneFromHdf5_T3D_ME_s scene;
	QtController *pcontroller;

public:
	QtApp_Posp_T3D_ME_s(int &argc, char **argv, Type tp = SingleFrame);
	~QtApp_Posp_T3D_ME_s();
