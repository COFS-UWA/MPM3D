...
#include "QtSceneFromHdf5_T3D_CHM_mt.h"

QtSceneFromHdf5_T3D_CHM_mt::QtSceneFromHdf5_T3D_CHM_mt(
...
void QtSceneFromHdf5_T3D_CHM_mt::clear()
{
...
void QtSceneFromHdf5_T3D_CHM_mt::close_file()
{
	if (!res_file)
		return;
...
void QtSceneFromHdf5_T3D_CHM_mt::update_view_mat()
{
...
void QtSceneFromHdf5_T3D_CHM_mt::update_light_pos()
{
...
size_t QtSceneFromHdf5_T3D_CHM_mt::get_frame_num()
{
...
double QtSceneFromHdf5_T3D_CHM_mt::get_frame_time(size_t frame_id)
{
	ResultFile_hdf5& rf = *res_file;
	double frame_time;
	char frame_name[50];
...
int QtSceneFromHdf5_T3D_CHM_mt::init_scene(int wd, int ht, size_t frame_id)
{
...
void QtSceneFromHdf5_T3D_CHM_mt::update_scene(size_t frame_id)
{
	ResultFile_hdf5 &rf = *res_file;
...
void QtSceneFromHdf5_T3D_CHM_mt::draw()
{
...
void QtSceneFromHdf5_T3D_CHM_mt::resize(int wd, int ht)
{
	win_wd = wd;
	win_ht = ht;
...
bool QtSceneFromHdf5_T3D_CHM_mt::init_color_map_texture()
{
	// color map texture
