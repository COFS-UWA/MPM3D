#ifndef __Qt_App_Posp_T2D_CHM_mt_h__
#define __Qt_App_Posp_T2D_CHM_mt_h__
...
class QtApp_Posp_T2D_CHM_mt;

namespace QtApp_Posp_T2D_CHM_mt_Internal
{
...
protected:
	...
	QtApp_Posp_T2D_CHM_mt_Internal::MainWindow window;
	QtSceneFromHdf5_T2D_CHM_mt scene;
	QtController *pcontroller;

public:
	QtApp_Posp_T2D_CHM_mt(int &argc, char **argv, Type tp = SingleFrame);
	~QtApp_Posp_T2D_CHM_mt();
