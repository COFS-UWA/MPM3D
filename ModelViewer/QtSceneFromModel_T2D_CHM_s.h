#ifndef __Qt_Scene_From_Model_T2D_CHM_s_h__
#define __Qt_Scene_From_Model_T2D_CHM_s_h__
...
class QtSceneFromModel_T2D_CHM_s : public QtSceneFromModel
{
protected:
	struct PointData
	{
...
public:
	QtSceneFromModel_T2D_CHM_s(QOpenGLFunctions_3_3_Core &_gl);
	~QtSceneFromModel_T2D_CHM_s();
	...
	inline void set_model(Model_T2D_CHM_s& _model) { model = &_model; }
