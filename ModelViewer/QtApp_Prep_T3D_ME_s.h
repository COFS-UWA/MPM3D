#ifndef __Qt_App_Prep_T3D_ME_s_h__
#define __Qt_App_Prep_T3D_ME_s_h__
...
class QtApp_Prep_T3D_ME_s;

namespace QtApp_Prep_T3D_ME_s_Internal
{
...
protected:
	...
	QtApp_Prep_T3D_ME_s_Internal::MainWindow window;
	QtSceneFromModel_T3D_ME_s scene;
	QtController_Prep controller;

public:
	QtApp_Prep_T3D_ME_s(int &argc, char **argv);
	~QtApp_Prep_T3D_ME_s();
