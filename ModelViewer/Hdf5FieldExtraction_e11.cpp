...
bool Hdf5FieldExtraction_e11::validate_data_type()
{
	...
	for (size_t mem_id = 0; mem_id < mem_num; ++mem_id)
	{
		...
		if (strcmp(mem_name, "e11") == 0)
		{
			...
			e11_fld_is_found = true;
			break;
		}
	}
	return e11_fld_is_found;
}

int Hdf5FieldExtraction_e11::extract_pcl_fld_data(double* pcl_fld_data)
{
	if (!e11_fld_is_found)
		return -1;
	...
	{
		pcl_fld_data[pcl_id] = *(double *)(cur_pcl + e11_offset);
		cur_pcl += pcl_size;
	}
	return 0;
}
