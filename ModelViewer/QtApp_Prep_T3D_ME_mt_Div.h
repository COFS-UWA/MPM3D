#ifndef __Qt_App_Prep_T3D_ME_mt_Div_h__
#define __Qt_App_Prep_T3D_ME_mt_Div_h__
...
#include "QtGLView.h"
#include "QtSceneFromModel_T3D_ME_mt_Div.h"
#include "QtController_Prep.h"

template <class DivisionSet>
class QtApp_Prep_T3D_ME_mt_Div;

namespace QtApp_Prep_T3D_ME_mt_Div_Internal
{
...
protected:
	template <class DivisionSet>
	friend class QtApp_Prep_T3D_ME_mt_Div;
...
protected:
	...
	QtApp_Prep_T3D_ME_mt_Div_Internal::MainWindow window;
	QtSceneFromModel_T3D_ME_mt_Div<DivisionSet> scene;
	QtController_Prep controller;

public:
	QtApp_Prep_T3D_ME_mt_Div(int &argc, char **argv);
	~QtApp_Prep_T3D_ME_mt_Div();
	...
	inline void set_model(Model_T3D_ME_mt& model) { scene.set_model(model); }
...
template <class DivisionSet>
QtApp_Prep_T3D_ME_mt_Div<DivisionSet>::QtApp_Prep_T3D_ME_mt_Div(int& argc, char** argv) :
	app(argc, argv),
	scene(window.get_view()),
	controller(window.get_view(), scene) {}

template <class DivisionSet>
QtApp_Prep_T3D_ME_mt_Div<DivisionSet>::~QtApp_Prep_T3D_ME_mt_Div() {}

template <class DivisionSet>
int QtApp_Prep_T3D_ME_mt_Div<DivisionSet>::start()
{
	window.show();
	return app.exec();
}
