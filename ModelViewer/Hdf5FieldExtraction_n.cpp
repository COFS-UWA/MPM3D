...
#include "Hdf5FieldExtraction_n.h"

bool Hdf5FieldExtraction_n::validate_data_type()
{
	...
	return n_fld_is_found;
}

int Hdf5FieldExtraction_n::extract_pcl_fld_data(double* pcl_fld_data)
{
	if (!n_fld_is_found)
		return -1;
	...
	{
		pcl_fld_data[pcl_id] = *(double *)(cur_pcl + n_offset);
		cur_pcl += pcl_size;
	}
	return 0;
}
