#ifndef __Qt_Scene_From_Model_T2D_ME_p_h__
#define __Qt_Scene_From_Model_T2D_ME_p_h__
...
class QtSceneFromModel_T2D_ME_p : public QtSceneFromModel
{
protected:
	struct PointData
	{
...
public:
	QtSceneFromModel_T2D_ME_p(QOpenGLFunctions_3_3_Core &_gl);
	~QtSceneFromModel_T2D_ME_p();
	...
	inline void set_model(Model_T2D_ME_p& _model) { model = &_model; }
