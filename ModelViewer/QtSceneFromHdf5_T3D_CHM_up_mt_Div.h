#ifndef __Qt_Scene_From_Hdf5_T3D_CHM_up_mt_Div_h__
#define __Qt_Scene_From_Hdf5_T3D_CHM_up_mt_Div_h__
...
class QtSceneFromHdf5_T3D_CHM_up_mt_Div :
	public QtSceneFromHdf5_T3D_CHM_up_mt
{
protected:
	DivisionSet div_set;

public:
	explicit QtSceneFromHdf5_T3D_CHM_up_mt_Div(QOpenGLFunctions_3_3_Core& _gl) :
		QtSceneFromHdf5_T3D_CHM_up_mt(_gl) {}
	~QtSceneFromHdf5_T3D_CHM_up_mt_Div() {}
...
template <class DivisionSet>
int QtSceneFromHdf5_T3D_CHM_up_mt_Div<DivisionSet>
	::init_scene(int wd, int ht, size_t frame_id)
{
...
template <class DivisionSet>
void QtSceneFromHdf5_T3D_CHM_up_mt_Div<DivisionSet>
