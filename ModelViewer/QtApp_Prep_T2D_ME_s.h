#ifndef __Qt_App_Prep_T2D_ME_s_h__
#define __Qt_App_Prep_T2D_ME_s_h__
...
protected:
	...
	QtApp_Prep_T2D_ME_s_Internal::MainWindow window;
	QtSceneFromModel_T2D_ME_s scene;
	QtController_Prep controller;

public:
	QtApp_Prep_T2D_ME_s(int &argc, char **argv);
	~QtApp_Prep_T2D_ME_s();
