#ifndef __Qt_Scene_From_Model_T3D_CHM_up_mt_h__
#define __Qt_Scene_From_Model_T3D_CHM_up_mt_h__
...
class QtSceneFromModel_T3D_CHM_up_mt :
...
public:
	...
	explicit QtSceneFromModel_T3D_CHM_up_mt(QOpenGLFunctions_3_3_Core &_gl);
	~QtSceneFromModel_T3D_CHM_up_mt();
	...
	inline void set_model(Model_T3D_CHM_up_mt &_model) { model = &_model; }
	...
	int set_pts_from_drained_bc(float radius);
