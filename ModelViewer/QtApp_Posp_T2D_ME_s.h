#ifndef __Qt_App_Posp_T2D_ME_s_h__
#define __Qt_App_Posp_T2D_ME_s_h__
...
protected:
	...
	QtApp_Posp_T2D_ME_s_Internal::MainWindow window;
	QtSceneFromHdf5_T2D_ME_s scene;
	QtController *pcontroller;

public:
	QtApp_Posp_T2D_ME_s(int &argc, char **argv, Type tp = SingleFrame);
	~QtApp_Posp_T2D_ME_s();
