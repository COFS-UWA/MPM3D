...
#include "QtSceneFromHdf5_T2D_CHM_mt.h"
...
void QtSceneFromHdf5_T2D_CHM_mt::clear()
{
...
void QtSceneFromHdf5_T2D_CHM_mt::close_file()
{
	if (!res_file)
		return;
...
void QtSceneFromHdf5_T2D_CHM_mt::set_viewport(
...
void QtSceneFromHdf5_T2D_CHM_mt::draw()
{
...
void QtSceneFromHdf5_T2D_CHM_mt::resize(int wd, int ht)
{
...
size_t QtSceneFromHdf5_T2D_CHM_mt::get_frame_num()
{
...
double QtSceneFromHdf5_T2D_CHM_mt::get_frame_time(size_t frame_id)
{
	ResultFile_hdf5& rf = *res_file;
	double frame_time;
	char frame_name[50];
...
int QtSceneFromHdf5_T2D_CHM_mt::init_scene(int wd, int ht, size_t frame_id)
{
	...
	using Model_T2D_CHM_mt_hdf5_utilities::get_node_dt_id;
	using Model_T2D_CHM_mt_hdf5_utilities::NodeData;
	hid_t node_dt_id = Model_T2D_CHM_mt_hdf5_utilities::get_node_dt_id();
	...
	using Model_T2D_CHM_mt_hdf5_utilities::get_element_dt_id;
	using Model_T2D_CHM_mt_hdf5_utilities::ElementData;
