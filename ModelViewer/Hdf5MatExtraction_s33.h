#ifndef __Hdf5_Mat_Extraction_s33_h__
#define __Hdf5_Mat_Extraction_s33_h__

#include "Hdf5FieldExtraction.h"

class Hdf5MatExtraction_s33 : public Hdf5FieldExtraction
{
protected:
...
public:
	Hdf5MatExtraction_s33() : mat_id_is_found(false) {}
	Hdf5MatExtraction_s33(Hdf5DataLoader& loader) :
		Hdf5FieldExtraction(loader), mat_id_is_found(false) {}
	~Hdf5MatExtraction_s33() {}
