...
#include "QtSceneFromHdf5_T3D_CHM_up_mt.h"

QtSceneFromHdf5_T3D_CHM_up_mt::QtSceneFromHdf5_T3D_CHM_up_mt(
...
void QtSceneFromHdf5_T3D_CHM_up_mt::clear()
{
...
void QtSceneFromHdf5_T3D_CHM_up_mt::close_file()
{
	if (!res_file)
		return;
...
void QtSceneFromHdf5_T3D_CHM_up_mt::update_view_mat()
{
...
void QtSceneFromHdf5_T3D_CHM_up_mt::update_proj_mat()
{
...
void QtSceneFromHdf5_T3D_CHM_up_mt::update_light_pos()
{
...
// ================== animation ==================
int QtSceneFromHdf5_T3D_CHM_up_mt::set_res_file(
	ResultFile_hdf5& rf,
	const char* th_name,
...
size_t QtSceneFromHdf5_T3D_CHM_up_mt::get_frame_num()
{
...
double QtSceneFromHdf5_T3D_CHM_up_mt::get_frame_time(size_t frame_id)
{
	ResultFile_hdf5& rf = *res_file;
	double frame_time;
	char frame_name[50];
...
int QtSceneFromHdf5_T3D_CHM_up_mt::init_scene(int wd, int ht, size_t frame_id)
{
...
void QtSceneFromHdf5_T3D_CHM_up_mt::update_scene(size_t frame_id)
{
	ResultFile_hdf5 &rf = *res_file;
...
void QtSceneFromHdf5_T3D_CHM_up_mt::draw()
{
...
void QtSceneFromHdf5_T3D_CHM_up_mt::resize(int wd, int ht)
{
	win_wd = wd;
	win_ht = ht;
...
void QtSceneFromHdf5_T3D_CHM_up_mt::init_rigid_objects_buffer(
	Cube &mh_bbox,
	ResultFile_hdf5& rf)
{
...
bool QtSceneFromHdf5_T3D_CHM_up_mt::init_color_map_texture()
{
	// color map texture
...
void QtSceneFromHdf5_T3D_CHM_up_mt::init_shaders(
...
void QtSceneFromHdf5_T3D_CHM_up_mt::update_rigid_objects_buffer(
	hid_t frame_grp_id,
	ResultFile_hdf5& rf)
{
