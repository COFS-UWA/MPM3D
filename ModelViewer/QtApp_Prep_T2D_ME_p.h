#ifndef __Qt_App_Prep_T2D_ME_p_h__
#define __Qt_App_Prep_T2D_ME_p_h__
...
protected:
	...
	QtApp_Prep_T2D_ME_p_Internal::MainWindow window;
	QtSceneFromModel_T2D_ME_p scene;
	QtController_Prep controller;

public:
	QtApp_Prep_T2D_ME_p(int &argc, char **argv);
	~QtApp_Prep_T2D_ME_p();
	...
	inline void set_model(Model_T2D_ME_p& model) { scene.set_model(model); }
