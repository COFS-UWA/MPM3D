...
#include "QtSceneFromHdf5_T2D_ME_p.h"

QtSceneFromHdf5_T2D_ME_p::QtSceneFromHdf5_T2D_ME_p(
...
void QtSceneFromHdf5_T2D_ME_p::close_file()
{
	if (!res_file)
		return;
...
void QtSceneFromHdf5_T2D_ME_p::clear()
{
...
void QtSceneFromHdf5_T2D_ME_p::set_viewport(
...
void QtSceneFromHdf5_T2D_ME_p::draw()
{
...
void QtSceneFromHdf5_T2D_ME_p::resize(int wd, int ht)
{
...
// ================== animation ==================
int QtSceneFromHdf5_T2D_ME_p::set_res_file(
	ResultFile_hdf5& rf,
	const char* th_na,
	const char* field_na
	)
...
size_t QtSceneFromHdf5_T2D_ME_p::get_frame_num()
{
	ResultFile_hdf5& rf = *res_file;
	size_t frame_num;
...
double QtSceneFromHdf5_T2D_ME_p::get_frame_time(size_t frame_id)
{
	ResultFile_hdf5& rf = *res_file;
	double frame_time;
	char frame_name[50];
...
int QtSceneFromHdf5_T2D_ME_p::init_scene(int wd, int ht, size_t frame_id)
{
...
void QtSceneFromHdf5_T2D_ME_p::update_scene(size_t frame_id)
{
	ResultFile_hdf5 &rf = *res_file;
	char frame_name[50];
	snprintf(frame_name, 50, "frame_%zu", frame_id);
