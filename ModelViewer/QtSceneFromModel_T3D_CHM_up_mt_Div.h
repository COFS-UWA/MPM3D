#ifndef __Qt_Scene_From_Model_T3D_CHM_up_mt_Div_h__
#define __Qt_Scene_From_Model_T3D_CHM_up_mt_Div_h__
...
class QtSceneFromModel_T3D_CHM_up_mt_Div :
	public QtSceneFromModel_T3D_CHM_up_mt
{
protected:
	DivisionSet div_set;

public:
	QtSceneFromModel_T3D_CHM_up_mt_Div(QOpenGLFunctions_3_3_Core& _gl) :
		QtSceneFromModel_T3D_CHM_up_mt(_gl) {}
	~QtSceneFromModel_T3D_CHM_up_mt_Div() {}
	...
	int initialize(int wd, int ht)
	{
		...
		bg_mesh_obj.init_from_elements<
			Model_T3D_CHM_up_mt::Position,
			Model_T3D_CHM_up_mt::ElemNodeIndex,
			DivisionSet>(
			model->get_node_pos(),
			model->get_node_num(),
