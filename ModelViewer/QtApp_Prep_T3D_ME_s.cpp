...
QtApp_Prep_T3D_ME_s::QtApp_Prep_T3D_ME_s(int &argc, char **argv) :
	app(argc, argv), scene(window.get_view()),
	controller(window.get_view(), scene) {}

QtApp_Prep_T3D_ME_s::~QtApp_Prep_T3D_ME_s() {}

int QtApp_Prep_T3D_ME_s::start()
{
	window.show();
	return app.exec();
}
