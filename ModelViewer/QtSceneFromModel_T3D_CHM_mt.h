#ifndef __Qt_Scene_From_Model_T3D_CHM_mt_h__
#define __Qt_Scene_From_Model_T3D_CHM_mt_h__
...
class QtSceneFromModel_T3D_CHM_mt :
...
public:
	...
	explicit QtSceneFromModel_T3D_CHM_mt(QOpenGLFunctions_3_3_Core &_gl);
	~QtSceneFromModel_T3D_CHM_mt();
	...
	inline void set_model(Model_T3D_CHM_mt &_model) { model = &_model; }
	...
	int set_pts_from_vz_s_bc(float radius);
	int set_pts_from_vx_f_bc(float radius);
	int set_pts_from_vy_f_bc(float radius);
	int set_pts_from_vz_f_bc(float radius);
	int set_pts_from_vec_s_bc(float radius);
	int set_pts_from_vec_f_bc(float radius);
