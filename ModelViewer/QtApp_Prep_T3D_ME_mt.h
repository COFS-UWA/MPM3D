#ifndef __Qt_App_Prep_T3D_ME_mt_h__
#define __Qt_App_Prep_T3D_ME_mt_h__
...
protected:
	...
	QtApp_Prep_T3D_ME_mt_Internal::MainWindow window;
	QtSceneFromModel_T3D_ME_mt scene;
	QtController_Prep controller;

public:
	QtApp_Prep_T3D_ME_mt(int &argc, char **argv);
	~QtApp_Prep_T3D_ME_mt();
