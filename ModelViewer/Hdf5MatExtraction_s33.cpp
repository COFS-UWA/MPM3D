...
bool Hdf5MatExtraction_s33::validate_data_type()
{
...
int Hdf5MatExtraction_s33::extract_pcl_fld_data(double* pcl_fld_data)
{
	...
	for (size_t pcl_id = 0; pcl_id < pcl_num; ++pcl_id)
	{
		...
		pcl_fld_data[pcl_id] = *(double*)(((char*)mat_tp) + mat_info.s33_off);
		cur_pcl += pcl_size;
	}
	return 0;
}
