#ifndef __Qt_Scene_From_Model_T3D_CHM_s_h__
#define __Qt_Scene_From_Model_T3D_CHM_s_h__
...
class QtSceneFromModel_T3D_CHM_s : public QtSceneFromModel
{
protected:
...
public:
	explicit QtSceneFromModel_T3D_CHM_s(QOpenGLFunctions_3_3_Core &_gl);
	~QtSceneFromModel_T3D_CHM_s();
	...
	inline void set_model(Model_T3D_CHM_s &_model) { model = &_model; }
