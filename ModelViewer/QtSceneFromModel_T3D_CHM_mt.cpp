...
#include "QtSceneFromModel_T3D_CHM_mt.h"

QtSceneFromModel_T3D_CHM_mt::QtSceneFromModel_T3D_CHM_mt(
...
void QtSceneFromModel_T3D_CHM_mt::update_view_mat()
{
...
void QtSceneFromModel_T3D_CHM_mt::update_proj_mat()
{
...
void QtSceneFromModel_T3D_CHM_mt::update_light_pos()
{
...
int QtSceneFromModel_T3D_CHM_mt::set_pts_from_pcl_id(
...
int QtSceneFromModel_T3D_CHM_mt::set_pts_from_node_id(
	size_t* ids, size_t id_num, float radius)
{
	if (!model || !ids || !id_num || radius <= 0.0f)
		return -1;
...
int QtSceneFromModel_T3D_CHM_mt::set_pts_from_vx_s_bc(float radius)
{
	Model_T3D_CHM_mt& md = *model;
	size_t node_num = md.get_node_num();
	const Model_T3D_CHM_mt::NodeHasVBC* nhv = md.get_node_has_vbc_s();
...
int QtSceneFromModel_T3D_CHM_mt::set_pts_from_vy_s_bc(float radius)
{
	Model_T3D_CHM_mt& md = *model;
	size_t node_num = md.get_node_num();
	const Model_T3D_CHM_mt::NodeHasVBC* nhv = md.get_node_has_vbc_s();
...
int QtSceneFromModel_T3D_CHM_mt::set_pts_from_vz_s_bc(float radius)
{
	Model_T3D_CHM_mt& md = *model;
	size_t node_num = md.get_node_num();
	const Model_T3D_CHM_mt::NodeHasVBC* nhv = md.get_node_has_vbc_s();
...
int QtSceneFromModel_T3D_CHM_mt::set_pts_from_vx_f_bc(float radius)
{
	Model_T3D_CHM_mt& md = *model;
	size_t node_num = md.get_node_num();
	const Model_T3D_CHM_mt::NodeHasVBC* nhv = md.get_node_has_vbc_f();
	const Position* node_pos = md.get_node_pos();
	pt_radius = radius;
	pt_num = 0;
	pts_mem.reserve(100);
...
int QtSceneFromModel_T3D_CHM_mt::set_pts_from_vy_f_bc(float radius)
{
	Model_T3D_CHM_mt& md = *model;
	size_t node_num = md.get_node_num();
	const Model_T3D_CHM_mt::NodeHasVBC* nhv = md.get_node_has_vbc_f();
...
int QtSceneFromModel_T3D_CHM_mt::set_pts_from_vz_f_bc(float radius)
{
	Model_T3D_CHM_mt& md = *model;
	size_t node_num = md.get_node_num();
	const Model_T3D_CHM_mt::NodeHasVBC* nhv = md.get_node_has_vbc_f();
...
int QtSceneFromModel_T3D_CHM_mt::set_pts_from_vec_s_bc(float radius)
{
	Model_T3D_CHM_mt& md = *model;
	size_t node_num = md.get_node_num();
	const Model_T3D_CHM_mt::NodeVBCVec* nvec = md.get_node_vbc_vec_s();
	const Position* node_pos = md.get_node_pos();
	pt_radius = radius;
	pt_num = 0;
	pts_mem.reserve(100);
...
int QtSceneFromModel_T3D_CHM_mt::set_pts_from_vec_f_bc(float radius)
{
	Model_T3D_CHM_mt& md = *model;
	size_t node_num = md.get_node_num();
	const Model_T3D_CHM_mt::NodeVBCVec* nvec = md.get_node_vbc_vec_f();
	const Position* node_pos = md.get_node_pos();
	pt_radius = radius;
	pt_num = 0;
	pts_mem.reserve(100);
...
int QtSceneFromModel_T3D_CHM_mt::initialize(int wd, int ht)
{
	...
	Model_T3D_CHM_mt::Position* pcl_pos1
		= (Model_T3D_CHM_mt::Position*)::operator new(sizeof(Model_T3D_CHM_mt::Position) * pcl_num);
...
void QtSceneFromModel_T3D_CHM_mt::draw()
{
...
void QtSceneFromModel_T3D_CHM_mt::resize(int wd, int ht)
{
	width = wd;
	height = ht;
...
void QtSceneFromModel_T3D_CHM_mt::init_shaders()
{
...
void QtSceneFromModel_T3D_CHM_mt::init_pts_buffer()
{
...
void QtSceneFromModel_T3D_CHM_mt::init_rigid_objects_buffer()
{
