#ifndef __Qt_App_Posp_T3D_CHM_up_mt_h__
#define __Qt_App_Posp_T3D_CHM_up_mt_h__
...
class QtApp_Posp_T3D_CHM_up_mt;
...
protected:
	friend QtApp_Posp_T3D_CHM_up_mt;
	QtGLView *model_view;
...
protected:
	...
	QtApp_Posp_T3D_CHM_up_mt_Internal::MainWindow window;
	QtSceneFromHdf5_T3D_CHM_up_mt scene;
	QtController *pcontroller;

public:
	QtApp_Posp_T3D_CHM_up_mt(int &argc, char **argv, Type tp = SingleFrame);
	~QtApp_Posp_T3D_CHM_up_mt();
