#ifndef __Qt_App_Posp_T2D_ME_p_h__
#define __Qt_App_Posp_T2D_ME_p_h__
...
protected:
	...
	QtApp_Posp_T2D_ME_p_Internal::MainWindow window;
	QtSceneFromHdf5_T2D_ME_p scene;
	QtController *pcontroller;

public:
	QtApp_Posp_T2D_ME_p(int &argc, char **argv, Type tp = SingleFrame);
	~QtApp_Posp_T2D_ME_p();
