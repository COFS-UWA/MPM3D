#ifndef __Qt_App_Prep_T3D_CHM_mt_h__
#define __Qt_App_Prep_T3D_CHM_mt_h__
...
class QtApp_Prep_T3D_CHM_mt;

namespace QtApp_Prep_T3D_CHM_mt_Internal
{
...
protected:
	...
	QtApp_Prep_T3D_CHM_mt_Internal::MainWindow window;
	QtSceneFromModel_T3D_CHM_mt scene;
	QtController_Prep controller;

public:
	QtApp_Prep_T3D_CHM_mt(int &argc, char **argv);
	~QtApp_Prep_T3D_CHM_mt();
	...
	inline int set_pts_from_vx_bc_s(float radius) { return scene.set_pts_from_vx_s_bc(radius); }
	inline int set_pts_from_vy_bc_s(float radius) { return scene.set_pts_from_vy_s_bc(radius); }
	inline int set_pts_from_vz_bc_s(float radius) { return scene.set_pts_from_vz_s_bc(radius); }
	inline int set_pts_from_vx_bc_f(float radius) { return scene.set_pts_from_vx_f_bc(radius); }
	inline int set_pts_from_vy_bc_f(float radius) { return scene.set_pts_from_vy_f_bc(radius); }
	inline int set_pts_from_vz_bc_f(float radius) { return scene.set_pts_from_vz_f_bc(radius); }
	inline int set_pts_from_vec_bc_s(float radius) { return scene.set_pts_from_vec_s_bc(radius); }
	inline int set_pts_from_vec_bc_f(float radius) { return scene.set_pts_from_vec_f_bc(radius); }
