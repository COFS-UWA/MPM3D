#ifndef __Step_T2D_CHM_mt_Geo_h__
#define __Step_T2D_CHM_mt_Geo_h__
...
{
	int load_model_from_hdf5_file(Model_T2D_CHM_mt& md, const char* hdf5_name);
	//int load_model_from_hdf5_file(Model_T2D_CHM_mt& md, Step_T2D_CHM_mt_Geo& step,
...
class Step_T2D_CHM_mt_Geo : public Step_OMP
{
protected:
...
public:
	...
	friend int substep_func_omp_T2D_CHM_mt_Geo(void* _self,
		size_t my_th_id, double dt, double cur_time, size_t substp_id);
	int finalize_calculation() override;

public:
	Step_T2D_CHM_mt_Geo(const char* _name);
	~Step_T2D_CHM_mt_Geo();
	...
	static void reorder(Model_T2D_CHM_mt& md, size_t valid_pcl_num, const size_t* prev_pcl_ids);

	//friend int Model_T2D_CHM_mt_hdf5_utilities::load_model_from_hdf5_file(
	//	Model_T2D_CHM_mt &md, Step_T2D_CHM_mt_Geo &step, const char *hdf5_name,
