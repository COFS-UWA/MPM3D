...
int TimeHistory_T3D_ME_mt_Geo_complete::init()
{
	if (is_init)
		return 0;
...
void TimeHistory_T3D_ME_mt_Geo_complete::close()
{
	const char* res_file_type = res_file->get_type();
	if (!strcmp(res_file_type, "ResultFile_XML"))
	{
...
{
//	TimeHistory_T3D_ME_mt_Geo_complete &th = static_cast<TimeHistory_T3D_ME_mt_Geo_complete &>(_self);
//	Step_T3D_ME_mt& step = static_cast<Step_T3D_ME_mt&>(th.get_step());
//	Model_T3D_ME_mt& model = static_cast<Model_T3D_ME_mt&>(step.get_model());
...
//	Model_T3D_ME_mt::Particle *pcls = model.get_pcls();
...
//	{
//		Model_T3D_ME_mt::Particle &pcl = pcls[pcl_id];
//		file << "        ";
...
{
	TimeHistory_T3D_ME_mt_Geo_complete &th = static_cast<TimeHistory_T3D_ME_mt_Geo_complete &>(_self);
	Step_T3D_ME_mt_Geo &step = static_cast<Step_T3D_ME_mt_Geo &>(th.get_step());
	Model_T3D_ME_mt &md = static_cast<Model_T3D_ME_mt &>(step.get_model());
	...
	using Model_T3D_ME_mt_hdf5_utilities::time_history_complete_output_to_hdf5_file;
