#ifndef __Step_T3D_CHM_up_TBB2_h__
#define __Step_T3D_CHM_up_TBB2_h__

#include "PclSort.h"
#include "NodeElemSort.hpp"
#include "Model_T3D_CHM_up_mt.h"
#include "Step_T3D_CHM_up_TBB2_Task.h"
#include "Step_TBB.h"
...
class Step_T3D_CHM_up_TBB2 : public Step_TBB
{
protected:
	...
	// ParaUtil
	typedef Step_T3D_CHM_up_TBB2_Task::InitPcl InitPcl;
	typedef Step_T3D_CHM_up_TBB2_Task::MapPclToBgMesh MapPclToBgMesh;
	typedef Step_T3D_CHM_up_TBB2_Task::FindSoilSurface FindSoilSurface;
	typedef Step_T3D_CHM_up_TBB2_Task::CalNodalVelocityAndPressure CalNodalVelocityAndPressure;
	typedef Step_T3D_CHM_up_TBB2_Task::FormNodalForce FormNodalForce;
	typedef Step_T3D_CHM_up_TBB2_Task::UpdateNodalVelocityAndPressure UpdateNodalVelocityAndPressure;
	typedef Step_T3D_CHM_up_TBB2_Task::MapBgMeshToPcl MapBgMeshToPcl;
	typedef Step_T3D_CHM_up_TBB2_Task::ContactRigidBody ContactRigidBody;
	// reduce res
	typedef Step_T3D_CHM_up_TBB2_Task::InitPclRes InitPclRes;
	typedef Step_T3D_CHM_up_TBB2_Task::MapPclToBgMeshRes MapPclToBgMeshRes;
	typedef Step_T3D_CHM_up_TBB2_Task::MapBgMeshToPclRes MapBgMeshToPclRes;
	//
	friend class InitPcl;
	friend class MapPclToBgMesh;
	friend class FindSoilSurface;
	friend class CalNodalVelocityAndPressure;
	friend class FormNodalForce;
	friend class UpdateNodalVelocityAndPressure;
	...
	CalNodalVelocityAndPressure cal_node_v_p;
	FormNodalForce form_nodal_force;
	UpdateNodalVelocityAndPressure update_node_v_p;
...
public:
	Step_T3D_CHM_up_TBB2(const char* _name);
	~Step_T3D_CHM_up_TBB2();
	...
	friend int Model_T3D_CHM_up_mt_hdf5_utilities::output_pcl_data_to_hdf5_file(
		Model_T3D_CHM_up_mt& md, Step_T3D_CHM_up_TBB2& stp, ResultFile_hdf5& rf, hid_t grp_id);
	friend int Model_T3D_CHM_up_mt_hdf5_utilities::time_history_complete_output_to_hdf5_file(
		Model_T3D_CHM_up_mt& md, Step_T3D_CHM_up_TBB2& stp, ResultFile_hdf5& rf, hid_t frame_grp_id);
	friend int Model_T3D_CHM_up_mt_hdf5_utilities::load_model_from_hdf5_file(
		Model_T3D_CHM_up_mt& md, const char* hdf5_name);
	friend int Model_T3D_CHM_up_mt_hdf5_utilities::load_model_from_hdf5_file(
		Model_T3D_CHM_up_mt& md, Step_T3D_CHM_up_TBB2& step,
