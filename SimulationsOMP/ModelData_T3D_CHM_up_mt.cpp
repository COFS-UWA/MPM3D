...
{
	//ModelData_T3D_CHM_up_mt &md = static_cast<ModelData_T3D_CHM_up_mt &>(_self);
...
{
	ModelData_T3D_CHM_up_mt &md = static_cast<ModelData_T3D_CHM_up_mt &>(_self);
	Model_T3D_CHM_up_mt &model = static_cast<Model_T3D_CHM_up_mt &>(*md.model);
	ResultFile_hdf5 &rf = static_cast<ResultFile_hdf5 &>(*md.res_file);
	using Model_T3D_CHM_up_mt_hdf5_utilities::output_model_to_hdf5_file;
