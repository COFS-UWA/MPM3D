...
protected:
	...
	double Kf, k, miu;
	double m_cav, u_cav, u_cav0, Kf_min_ratio; // param for cavitation
...
public:
	...
	inline void set_cavitation(double _m_cav, double _u_cav, double _u_cav0 = 0.0) noexcept
	{ m_cav = _m_cav; u_cav = _u_cav; u_cav0 = _u_cav0; }
	inline void set_cavi_Kf_min_ratio(double _Kf_min_ratio)
	{ Kf_min_ratio = _Kf_min_ratio; }
