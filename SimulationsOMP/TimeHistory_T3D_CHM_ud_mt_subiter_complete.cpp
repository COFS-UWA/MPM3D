...
int TimeHistory_T3D_CHM_ud_mt_subiter_complete::init()
{
	if (is_init)
		return 0;
...
void TimeHistory_T3D_CHM_ud_mt_subiter_complete::close()
{
	const char* res_file_type = res_file->get_type();
	if (!strcmp(res_file_type, "ResultFile_XML"))
	{
...
{
//	TimeHistory_T3D_CHM_ud_mt_subiter_complete &th = static_cast<TimeHistory_T3D_CHM_ud_mt_subiter_complete &>(_self);
