...
int TimeHistory_T3D_CHM_up_TBB2_complete::init()
{
	if (is_init)
		return 0;
...
void TimeHistory_T3D_CHM_up_TBB2_complete::close()
{
	const char* res_file_type = res_file->get_type();
	if (!strcmp(res_file_type, "ResultFile_XML"))
	{
...
{
//	TimeHistory_T3D_CHM_up_TBB2_complete &th = static_cast<TimeHistory_T3D_CHM_up_TBB2_complete &>(_self);
//	Step_T3D_CHM_TBB& step = static_cast<Step_T3D_CHM_TBB&>(th.get_step());
//	Model_T3D_CHM_mt& model = static_cast<Model_T3D_CHM_mt&>(step.get_model());
...
//	Model_T3D_CHM_mt::Particle *pcls = model.get_pcls();
...
//	{
//		Model_T3D_CHM_mt::Particle &pcl = pcls[pcl_id];
//		file << "        ";
...
{
	TimeHistory_T3D_CHM_up_TBB2_complete &th = static_cast<TimeHistory_T3D_CHM_up_TBB2_complete &>(_self);
	Step_T3D_CHM_up_TBB2 &step = static_cast<Step_T3D_CHM_up_TBB2 &>(th.get_step());
	Model_T3D_CHM_up_mt &md = static_cast<Model_T3D_CHM_up_mt &>(step.get_model());
	...
	using Model_T3D_CHM_up_mt_hdf5_utilities::time_history_complete_output_to_hdf5_file;
