#ifndef __Model_T3D_CHM_up_mt_hdf5_utilities_h__
#define __Model_T3D_CHM_up_mt_hdf5_utilities_h__
...
struct ParticleData
{
	...
	double u_cav, is_cavitated; // cavitation
	...
	{
		Model_T3D_CHM_up_mt::SortedPclVarArrays &psva
			= md.sorted_pcl_var_arrays[pcl_sorted_var_id];
		id = psva.pcl_index[pcl_offset];
		Model_T3D_CHM_up_mt::Force& pcl_bf_s = md.pcl_bf_s[id];
		bfx_s = pcl_bf_s.fx;
		bfy_s = pcl_bf_s.fy;
		bfz_s = pcl_bf_s.fz;
		Model_T3D_CHM_up_mt::Force& pcl_bf_f = md.pcl_bf_f[id];
		bfx_f = pcl_bf_f.fx;
		bfy_f = pcl_bf_f.fy;
		bfz_f = pcl_bf_f.fz;
		Model_T3D_CHM_up_mt::Force &pcl_t = md.pcl_t[id];
		tx = pcl_t.fx;
		ty = pcl_t.fy;
		tz = pcl_t.fz;
		...
		Model_T3D_CHM_up_mt::Position &pcl_pos = md.pcl_pos[id];
		Model_T3D_CHM_up_mt::Displacement &pcl_u = psva.pcl_u[pcl_offset];
		x = pcl_pos.x + pcl_u.ux;
		y = pcl_pos.y + pcl_u.uy;
		z = pcl_pos.z + pcl_u.uz;
		Model_T3D_CHM_up_mt::Velocity &pcl_v_s = psva.pcl_v_s[pcl_offset];
		vx_s = pcl_v_s.vx;
		vy_s = pcl_v_s.vy;
		vz_s = pcl_v_s.vz;
		Model_T3D_CHM_up_mt::Stress &pcl_stress = psva.pcl_stress[pcl_offset];
		s11 = pcl_stress.s11;
		s22 = pcl_stress.s22;
		s33 = pcl_stress.s33;
		s12 = pcl_stress.s12;
		...
		Model_T3D_CHM_up_mt::Strain& pcl_e = psva.pcl_strain[pcl_offset];
		e11 = pcl_e.e11;
		e22 = pcl_e.e22;
		e33 = pcl_e.e33;
		e12 = pcl_e.e12;
		e23 = pcl_e.e23;
		e31 = pcl_e.e31;
		Model_T3D_CHM_up_mt::Strain& pcl_ee = psva.pcl_estrain[pcl_offset];
		ee11 = pcl_ee.e11;
		ee22 = pcl_ee.e22;
		ee33 = pcl_ee.e33;
		ee12 = pcl_ee.e12;
		ee23 = pcl_ee.e23;
		ee31 = pcl_ee.e31;
		Model_T3D_CHM_up_mt::Strain& pcl_pe = psva.pcl_pstrain[pcl_offset];
		pe11 = pcl_pe.e11;
		pe22 = pcl_pe.e22;
		pe33 = pcl_pe.e33;
		pe12 = pcl_pe.e12;
		...
		size_t pcl_offset)
	{
		...
		const Model_T3D_CHM_up_mt::Force& pcl_bf_s = md.pcl_bf_s[id];
		bfx_s = pcl_bf_s.fx;
		bfy_s = pcl_bf_s.fy;
		bfz_s = pcl_bf_s.fz;
		const Model_T3D_CHM_up_mt::Force& pcl_bf_f = md.pcl_bf_f[id];
		bfx_f = pcl_bf_f.fx;
		bfy_f = pcl_bf_f.fy;
		bfz_f = pcl_bf_f.fz;
		const Model_T3D_CHM_up_mt::Force& pcl_t = md.pcl_t[id];
		tx = pcl_t.fx;
		ty = pcl_t.fy;
		tz = pcl_t.fz;
		...
		vol = m_s / (density_s * (1.0 - n));
		const Model_T3D_CHM_up_mt::Position& pcl_pos = md.pcl_pos[id];
		const Model_T3D_CHM_up_mt::Displacement& pcl_u_s = spva.pcl_u[pcl_offset];
		x = pcl_pos.x + pcl_u_s.ux;
		y = pcl_pos.y + pcl_u_s.uy;
		z = pcl_pos.z + pcl_u_s.uz;
		Model_T3D_CHM_up_mt::Velocity& pcl_v_s = spva.pcl_v_s[pcl_offset];
		vx_s = pcl_v_s.vx;
		vy_s = pcl_v_s.vy;
		vz_s = pcl_v_s.vz;
		Model_T3D_CHM_up_mt::Stress& pcl_stress = spva.pcl_stress[pcl_offset];
		s11 = pcl_stress.s11;
		s22 = pcl_stress.s22;
		s33 = pcl_stress.s33;
		s12 = pcl_stress.s12;
		...
		Model_T3D_CHM_up_mt::Strain& pcl_e = spva.pcl_strain[pcl_offset];
		e11 = pcl_e.e11;
		e22 = pcl_e.e22;
		e33 = pcl_e.e33;
		e12 = pcl_e.e12;
		e23 = pcl_e.e23;
		e31 = pcl_e.e31;
		Model_T3D_CHM_up_mt::Strain& pcl_ee = spva.pcl_estrain[pcl_offset];
		ee11 = pcl_ee.e11;
		ee22 = pcl_ee.e22;
		ee33 = pcl_ee.e33;
		ee12 = pcl_ee.e12;
		ee23 = pcl_ee.e23;
		ee31 = pcl_ee.e31;
		Model_T3D_CHM_up_mt::Strain& pcl_pe = spva.pcl_pstrain[pcl_offset];
		pe11 = pcl_pe.e11;
		pe22 = pcl_pe.e22;
		pe33 = pcl_pe.e33;
		pe12 = pcl_pe.e12;
		...
		MatModel::MaterialModel &mm)
	{
		...
		Model_T3D_CHM_up_mt::Strain& pcl_strain = psva.pcl_strain[pcl_offset];
		pcl_strain.e11 = e11;
		pcl_strain.e22 = e22;
		pcl_strain.e33 = e33;
		pcl_strain.e12 = e12;
		pcl_strain.e23 = e23;
		pcl_strain.e31 = e31;
		Model_T3D_CHM_up_mt::Strain& pcl_estrain = psva.pcl_estrain[pcl_offset];
		...
		Model_T3D_CHM_up_mt::Strain& pcl_pstrain = psva.pcl_pstrain[pcl_offset];
...
struct ElementData
{
	...
	double a3, b3, c3, d3;
	double a4, b4, c4, d4;
	double adj_e1, adj_e2, adj_e3, adj_e4;
};
...
inline hid_t get_element_dt_id()
{
	...
	H5Tinsert(res, "adj_e1", HOFFSET(ElementData, adj_e1), H5T_NATIVE_DOUBLE);
	H5Tinsert(res, "adj_e2", HOFFSET(ElementData, adj_e2), H5T_NATIVE_DOUBLE);
	H5Tinsert(res, "adj_e3", HOFFSET(ElementData, adj_e3), H5T_NATIVE_DOUBLE);
	H5Tinsert(res, "adj_e4", HOFFSET(ElementData, adj_e4), H5T_NATIVE_DOUBLE);
	return res;
}

struct NodeVBCData { bool has_vx_bc, has_vy_bc, has_vz_bc, is_drained; };
...
inline hid_t get_node_vbc_dt_id()
{
	...
	H5Tinsert(res, "is_drained", HOFFSET(NodeVBCData, is_drained), H5T_NATIVE_HBOOL);
	return res;
}
...
int output_search_mesh_to_hdf5_file(Model_T3D_CHM_up_mt& md, ResultFile_hdf5& rf, hid_t grp_id);
int load_search_mesh_from_hdf5_file(Model_T3D_CHM_up_mt& md, ResultFile_hdf5& rf, hid_t grp_id);
...
int output_t3d_rigid_mesh_state_to_hdf5_file(Model_T3D_CHM_up_mt& md, ResultFile_hdf5& rf, hid_t grp_id);
