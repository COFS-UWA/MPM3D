...
protected:
	...
	Step_T3D_ME_Task::CalData cal_data;
	Step_T3D_ME_Task::InitPcl init_pcl;
	Step_T3D_ME_Task::MapPclToBgMesh map_pcl_to_mesh;
	Step_T3D_ME_Task::ContactRigidRect cont_rigid_rect;
	Step_T3D_ME_Task::UpdateAccelerationAndVelocity update_a_and_v;
	Step_T3D_ME_Task::CalElemDeAndMapToNode cal_elem_de;
	Step_T3D_ME_Task::CalNodeDe cal_node_de;
	Step_T3D_ME_Task::MapBgMeshToPcl map_mesh_to_pcl;
