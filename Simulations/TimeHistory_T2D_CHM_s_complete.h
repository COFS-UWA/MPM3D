#ifndef __Time_History_T2D_CHM_s_complete_H__
#define __Time_History_T2D_CHM_s_complete_H__
...
int time_history_output_func_t2d_chm_s_to_xml_res_file(TimeHistory &_self);
int time_history_output_func_t2d_chm_s_to_hdf5_res_file(TimeHistory &_self);

/* ===========================================================
Class TimeHistory_T2D_CHM_s_complete
=========================================================== */
class TimeHistory_T2D_CHM_s_complete : public TimeHistory
{
protected:
	size_t output_id;
	bool is_init;
...
protected:
	hid_t th_id;
public:
	friend int time_history_output_func_t2d_chm_s_to_hdf5_res_file(TimeHistory &_self);
	inline void set_res_file(ResultFile_hdf5 &_res_file) noexcept
	{
		res_file = &_res_file;
		output_func = &time_history_output_func_t2d_chm_s_to_hdf5_res_file;
	}
};
