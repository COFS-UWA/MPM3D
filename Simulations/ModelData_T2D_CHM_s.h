#ifndef __Model_Data_T2D_CHM_s_H__
#define __Model_Data_T2D_CHM_s_H__
...
/*=============================================================
Class ModelData_T2D_CHM_s
==============================================================*/
class ModelData_T2D_CHM_s : public ModelData
{
public:
	ModelData_T2D_CHM_s(const char *_name = "ModelData") :
		ModelData(_name, "ModelData_T2D_CHM_s") {}
	~ModelData_T2D_CHM_s() {}

	friend int model_data_output_func_t2d_chm_s_to_xml_res_file(ModelData &_self);
	...
	friend int model_data_output_func_t2d_chm_s_to_hdf5_res_file(ModelData &_self);
