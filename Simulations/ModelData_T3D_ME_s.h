#ifndef __Model_Data_T3D_ME_s_H__
#define __Model_Data_T3D_ME_s_H__
...
==============================================================*/
class ModelData_T3D_ME_s : public ModelData
{
public:
	ModelData_T3D_ME_s(const char *_name = "ModelData") :
