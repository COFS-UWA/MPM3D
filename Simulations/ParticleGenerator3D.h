...
class TetrahedronMeshToParticles
{
public:
	struct Particle
	{
		double x, y, vol;
	protected:
		friend TetrahedronMeshToParticles;
...
//	typedef void(TetrahedronMeshToParticles::*GeneratorFunc)(Point &p1, Point &p2, Point &p3, double vol);
//
//public:
//	inline Particle *first() noexcept { return head.next; }
...
//
//public:
//	TetrahedronMeshToParticles(TetrahedronMesh &_mesh,
...
//	}
//
//	~TetrahedronMeshToParticles() { clear(); }
//
...
//	inline size_t get_pcl_num_per_elem() const noexcept { return generator_pcl_num[unsigned int(type)]; }
