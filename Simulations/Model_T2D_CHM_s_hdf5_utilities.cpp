	...
	)
{
	...
	// contact properteis
	rf.write_attribute(bg_mesh_grp_id, "Ks_cont", md.Ks_cont);
	rf.write_attribute(bg_mesh_grp_id, "Kf_cont", md.Kf_cont);
	...
	)
{
	...
	// contact properteis
	rf.read_attribute(bg_mesh_grp_id, "Ks_cont", md.Ks_cont);
	rf.read_attribute(bg_mesh_grp_id, "Kf_cont", md.Kf_cont);
	...
	)
{
	...
	rf.close_dataset(pcl_data_grp_id);
	return res;
}
