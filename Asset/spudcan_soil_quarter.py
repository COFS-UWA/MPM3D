...
depth = 4.0 * spudcan_radius
dense_depth = 2.0 * spudcan_radius
coarse_depth = 2.25 * spudcan_radius

width = 3.5 * spudcan_radius
dense_width = 2.0 * spudcan_radius
coarse_width = 2.25 * spudcan_radius
...
job = mdb.Job(name = 'spudcan_soil_quarter', model = 'Model-1',
...
mdb.saveAs(pathName = './spudcan_soil_quarter.cae')
