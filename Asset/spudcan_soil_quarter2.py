...
depth = 3.5 * spudcan_radius
dense_depth = 2.0 * spudcan_radius
coarse_depth = 2.3 * spudcan_radius

width = 2.7 * spudcan_radius
dense_width = 2.0 * spudcan_radius
coarse_width = 2.3 * spudcan_radius
...
job = mdb.Job(name = 'spudcan_soil_quarter2', model = 'Model-1',
...
mdb.saveAs(pathName = './spudcan_soil_quarter2.cae')
