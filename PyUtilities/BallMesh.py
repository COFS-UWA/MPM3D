...
""" % self.elem_num)
    ...
    def display(self):
        ...
        #ax.plot_trisurf(x, y, z, edgecolor='red')
        ax.set_xlabel('x')
        ax.set_ylabel('y')
        ax.set_zlabel('z')
        # ax.view_init(60, 35)
...
if __name__ == "__main__":
    ...
    #ball0.display()
    #ball0.write_to_cfile("ball_mesh_data.h")
    ball1 = BallMesh()
    ball1.subdivide(ball0)
    #ball1.write_to_cfile("ball_mesh_data.h")
    #ball1.display()
    ball2 = BallMesh()
    ball2.subdivide(ball1)
    ball2.write_to_cfile("ball_mesh_data.h")
