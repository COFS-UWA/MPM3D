...
if __name__ == "__main__":
    ...
    # nodes, elems = get_mesh_from_inp("../Asset/cone_pap2.inp", "Part-1")
    # output_mesh_to_hdf5(nodes, elems, "../Asset/cone_pap2.h5")
    # nodes, elems = get_mesh_from_inp("../Asset/spudcan_soil_half_cylinder_3_5R.inp", "Part-1")
    # move_mesh_in_z_direction(nodes, -6.0)
    # rotate_mesh(nodes, 0.0, 0.0, 90.0)
    # output_mesh_to_hdf5(nodes, elems, "../Asset/spudcan_soil_half_cylinder_3_5R.h5")