...
void test_t2d_me_mt_strip_footing(int argc, char** argv)
{
	...
	md_disp.set_display_range(-1.05, 6.5, -5.5, 0.8);
...
{
	ResultFile_hdf5 rf;
	rf.open("D:\\CalRes\\t2d_me_mt_strip_footing_rou_w2.h5");
	...
	app.set_win_size(1900, 900);
	app.set_res_file(rf, "loading", 100, Hdf5Field::plastic_mises_strain_2d);
	app.set_display_range(-1.05, 4.5, -3.0, 0.5);
	app.set_color_map_geometry(1.85f, 0.45f, 0.4f);
	app.set_color_map_fld_range(0.0, 0.55);
