...
void test_t3d_me_mt_cylinder_foundation_create_model_den(int argc, char** argv)
{
	...
	find_3d_nodes_on_x_plane(model, vx_bc_pt_array, 3.0, false);
	model.init_fixed_vx_bc(vx_bc_pt_array.get_num(), vx_bc_pt_array.get_mem());

	IndexArray vy_bc_pt_array(100);
	find_3d_nodes_on_y_plane(model, vy_bc_pt_array, -3.0);
	find_3d_nodes_on_y_plane(model, vy_bc_pt_array, 3.0, false);
...
void test_t3d_me_mt_cylinder_foundation_restart_den(int argc, char** argv)
{
	...
	Model_T3D_ME_mt_hdf5_utilities::load_me_mt_model_from_hdf5_file(
		model,
		step,
		"t3d_me_mt_cylinder_foundation_den.h5",
		"penetration",
		50
		);
	...
	ResultFile_hdf5 res_file_hdf5;
	res_file_hdf5.create("t3d_me_mt_cylinder_foundation_den2.h5");
...
void test_t3d_me_mt_cylinder_foundation_restart_den2(int argc, char** argv)
{
	Model_T3D_ME_mt model;
	...
	Model_T3D_ME_mt_hdf5_utilities::load_me_mt_model_from_hdf5_file(
		model,
		step,
		"t3d_me_mt_cylinder_foundation_den2.h5",
		"penetration",
		34
		);
	...
	ResultFile_hdf5 res_file_hdf5;
	res_file_hdf5.create("t3d_me_mt_cylinder_foundation_den3.h5");
...
void test_t3d_me_mt_cylinder_foundation_result_den2(int argc, char** argv)
{
	ResultFile_hdf5 rf;
	rf.open("t3d_me_mt_cylinder_foundation_den.h5");
	...
	//app.set_png_name("t3d_me_mt_cylinder_foundation_den");
	app.set_gif_name("t3d_me_mt_cylinder_foundation_den");
	app.start();
}
