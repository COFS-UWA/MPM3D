...
void test_t3d_chm_tbb_piezofoundation_sim_mat_model(int argc, char** argv)
{
	...
	teh_mesh.clear();
	model.init_pcls(pcl_generator, 0.3, den_grain, 1000.0, 1.0e7, 1.0e-7, 1.0);
	pcl_generator.clear();
	...
	res_file_hdf5.create("t3d_chm_tbb_piezofoundation_sim_mat_model.h5");
...
void test_t3d_chm_tbb_piezofoundation_sim_mat(int argc, char** argv)
{
	...
	Model_T3D_CHM_mt_hdf5_utilities::load_model_from_hdf5_file(
		model, "t3d_chm_tbb_piezofoundation_sim_mat_model.h5");
	...
	//ResultFile_hdf5 res_file_hdf5;
	//res_file_hdf5.create("t3d_chm_tbb_piezofoundation.h5");
...
{
	ResultFile_hdf5 rf;
	rf.open("t3d_chm_tbb_piezofoundation.h5");
	...
	//
	app.set_color_map_geometry(1.2f, 0.4f, 0.45f);
	app.set_png_name("t3d_chm_tbb_piezofoundation");
	app.set_gif_name("t3d_chm_tbb_piezofoundation");
	app.start();
}
