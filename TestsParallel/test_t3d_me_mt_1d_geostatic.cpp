...
void test_t3d_me_mt_1d_geostatic(int argc, char** argv)
{
	...
	res_file_hdf5.create("t3d_me_mt_1d_geostatic.h5");
...
{
	ResultFile_hdf5 rf;
	rf.open("t3d_me_mt_1d_geostatic.h5");
	...
	//app.set_png_name("t3d_me_mt_1d_geostatic");
	//app.set_gif_name("t3d_me_mt_1d_geostatic");
	app.start();
}
