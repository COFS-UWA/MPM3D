...
void test_t3d_me_mt_spudcan_sand_hypo_model(int argc, char** argv)
{
	...
	res_file_hdf5.create("t3d_me_mt_spudcan_sand_hypo_model.h5");
...
void test_t3d_me_mt_spudcan_sand_hypo(int argc, char** argv)
{
	...
	Model_T3D_ME_mt_hdf5_utilities::load_me_mt_model_from_hdf5_file(
		model, "t3d_me_mt_spudcan_sand_hypo_model.h5");
	...
	ResultFile_hdf5 res_file_hdf5;
	res_file_hdf5.create("t3d_me_mt_spudcan_sand_hypo.h5");
