...
void test_t2d_chm_mt_pipe_conference_den(int argc, char** argv)
{
	...
	pcl_generator.generate_pcls_in_grid_layout(Rect(-3.5, 3.5, -5.0, -3.5), 0.03, 0.03);
	pcl_generator.replace_with_pcls_in_grid_layout(Rect(-2.5, 2.5, -3.5, 0.0), 0.01, 0.01);
	...
	res_file_hdf5.create("t2d_chm_mt_pipe_conference_den1.h5");
