...
void test_t2d_chm_s_test_restart_geo_step(int argc, char** argv)
{
	...
	res_file_hdf5.create("t2d_chm_s_test_restart_geo.h5");
...
void test_t2d_chm_s_test_restart_consolidation_step(int argc, char** argv)
{
	...
	ResultFile_hdf5 res_file_hdf5;
	res_file_hdf5.create("t2d_chm_s_test_restart_consolidation.h5");
...
{
	ResultFile_hdf5 rf;
	rf.open("t2d_chm_s_test_restart_geo.h5");
...
{
	ResultFile_hdf5 rf;
	rf.open("t2d_chm_s_test_restart_consolidation.h5");
