...
void test_t2d_me_s_shallow_foundation_smaller_soil(int argc, char** argv)
{
	...
	res_file_hdf5.create("t2d_me_s_shallow_foundation_smaller_soil.h5");
...
{
	ResultFile_hdf5 rf;
	rf.open("t2d_me_s_shallow_foundation_smaller_soil.h5");
